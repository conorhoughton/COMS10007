...
preceding a given node in the shortest path; this would allow the path to be retraced afterwards. This is shown in Fig.~\ref{fig:path}. A function to implement Dijsktra's algorithm and store the path, can be seen at Table~\ref{c_dijkstra}.
