...
This style of definition is referred to as an epsilon-delta-box. You
...
You might wonder why you'd want to differentiate the top and the
...
\ln{x}=\log_e{x}
\end{equation}
the natural log because it is more convenient for differentiation,
however, in computer science the log to the base two, $\log_2{x}$ is
