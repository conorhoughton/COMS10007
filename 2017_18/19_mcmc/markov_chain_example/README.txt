...
A second-order markov model that attempts to generate lyrics in the style 
of your favorite artist.

##How does it work??

Building a markov chain involves the following critical steps:

1) Collecting training data (in this case, song of said artist. See fetch.py)
...
where Wi is a word, END denotes a newline.
...
So our initial looks something likes [W0, W5, W5]
...
Now, we pick out a word that has a high likelihood of occurring AFTER W5. We have a list of words that occur after W5 as the second word =[W3, W6]. Let's say we pick W3.

We then pick a word that occurs AFTER W5 and W3.  There's 2 options: ["END", "END", W3]. Say we pick W3. Repeat: pick a word that occurs after W3 and W3. Keep doing this until you hit "END", at which point you start the whole process on a new line.
