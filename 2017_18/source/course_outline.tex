...
\node[data,text height=0.35cm,above right = 0.5cm and 2cm of btr](atr){adversarial};
\node[data,text height=0.35cm, above right = -1.25cm and 2cm of btr](bhe){binary heaps};
\node[data,text height=0.35cm,below right = 1cm of btr](has){hashing};
\node[data,text height=0.35cm,right = 0.725cm of gra](ase){avl trees};

\path (btr) edge[<->,line width=1pt](ase);
