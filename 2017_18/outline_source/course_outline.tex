...
\node[intro,text height=0.35cm,right = 2cm of int](bse){binary search};

\path (int) edge[<->,line width=2pt](bse);
...
\path (int) edge[->,line width=2pt](boh);
\path (boh) edge[<->,line width=2pt](rma);
...
\path (boh) edge[<->,line width=2pt](lim);

\path (boh) edge[<->,line width=2pt](sea);
\path (boh) edge[<->,line width=2pt](rec);
\path (boh) edge[<->,line width=2pt](fib);

\node[big-oh,text height=0.35cm,below = 2cm of boh](mas){master};

\path (boh) edge[->,line width=2pt](mas);
...
\path (mas) edge[->,line width=2pt](qso);
\path (qso) edge[->,line width=2pt](mso);
\path (mso) edge[->,line width=2pt](rso);
...
\draw[->,rounded corners=5pt,line width=2pt] (rso)-|(gra);
...
\path (gra) edge[<->,line width=2pt](dij);
\path (gra) edge[<->,line width=2pt](ase);
\path (gra) edge[<->,line width=2pt](sth);

\node[data,text height=0.35cm,below = 2cm of gra](btr){binary trees};
...
\path (gra) edge[->,line width=2pt](btr);
\path (btr) edge[<->,line width=2pt](atr);
\path (btr) edge[<->,line width=2pt](bhe);
...
\path (btr) edge[->,line width=2pt](sci);
\path (sci) edge[<->,line width=2pt](sim);
\path (sci) edge[<->,line width=2pt](sma);
\path (sci) edge[<->,line width=2pt,color=gray](mcmc);
